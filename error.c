...
void error_print (int ne) {
  ...
  case 3:  printf("\t Warning %d: falta comilla de cierre. la l�ea ser�consumida\n", ne); break;
  case 4:  printf("\t Warning %d: Identificador de mas de 8 caracteres, ser�truncado\n", ne); break;
  case 5:  printf("\t Error %d: Caracter invalido\n", ne); break;
  case 6:  printf("\t Error %d: El nmero de argumentos no coincide. ucc programa.c \n", ne); break;
  ...
  case 11: printf("\t Error %d: Tabla de S�bolos vac�\n", ne); break;
  case 12: printf("\t Error %d: Tabla de S�bolos llena\n", ne); break;
  case 13: printf("\t Error %d: Tabla de Bloques llena\n", ne); break;
  case 14: printf("\t Error %d: Tabla de Bloques vac�\n", ne); break;
  /* errores de parser*/
  ...
  case 18: printf("\t Error %d: En Especificar Declaracin\n", ne); break;
  ...
  case 25: printf("\t Error %d: Error en proposicin\n", ne); break;
  ...
  case 34: printf("\t Error %d: Se esperaba identificador de funcin\n", ne); break;
  ...
  case 39: printf("\t Error %d: El identificador debe ser una variable o par�etro\n", ne); break;
  case 40: printf("\t Error %d: En una expresion, los arreglos deben ser accedidos por sus elementos\n", ne); break;
 case 41: printf("\t Error %d: La cantidad de elementos debe estar especificada por un entero\n", ne); break; // Error definido por nosotros
 }
}
